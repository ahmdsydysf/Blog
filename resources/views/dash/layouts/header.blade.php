...
<head>
    ...
    <link href="{{ asset('dash_assets/vendors/jquery-toggles/css/themes/toggles-light.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                <img class="brand-img d-inline-block" src="{{ asset('dash_assets/dist/img/logo-light.png') }}"
                    alt="brand" />
            </a>
                        ...
                        <div class="notifications-nicescroll-bar">
                                ...
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('dash_assets/dist/img/avatar1.jpg') }}') }}" alt="user"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('dash_assets/dist/img/avatar2.jpg') }}" alt="user"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown"
                        ...
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="{{ asset('dash_assets/dist/img/avatar12.jpg') }}" alt="user"
                                        class="avatar-img rounded-circle">
                                </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX"
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="dropdown-icon zmdi zmdi-power"></i>
                ...
                <div class="settings-panel-wrap">
                    <div class="settings-panel-head">
                        <img class="brand-img d-inline-block align-top"
                            src="{{ asset('dash_assets/dist/img/logo-light.png') }}" alt="brand" />
                    ...
                    <div class="layout-img-wrap">
                        <div class="row">
                            <a href="dashboard1.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dash_assets/dist/img/layout1.png') }}"
                                    alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="dashboard2.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dash_assets/dist/img/layout2.png') }}"
                                    alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="dashboard3.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dash_assets/dist/img/layout3.png') }}"
                                    alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="javascript:void(0);" class="col-6 mb-30 active">
                                <img class="rounded opacity-70" src="{{ asset('dash_assets/dist/img/layout4.png') }}"
                                    alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="dashboard5.html" class="col-6">
                                <img class="rounded opacity-70" src="{{ asset('dash_assets/dist/img/layout5.png') }}"
                                    alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                        </div>
